...
public class TankBlockRenderer implements BlockEntityRenderer<TankBlockEntity, TankBlockRenderer.TankBlockEntityRenderState>
{
...
//		};
	...
	public TankBlockRenderer(final BlockEntityRendererProvider.Context context)
	{
	...
	@Override
	public void extractRenderState(TankBlockEntity blockEntity, TankBlockEntityRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress)
	{

	}

	@Override
	public void submit(TankBlockEntityRenderState state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState camera)
	{
